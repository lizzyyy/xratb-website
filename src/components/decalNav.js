      ...
      <div className={navStyles.navBar}>
        ...
        <div className={navStyles.group}>
            <Link to="/decal/labs" className={navStyles.title}>
              <div className={open.includes("labs") ? navStyles.arrowOpen : navStyles.arrow}>></div>
              <div className={open.includes("labs") ? navStyles.active : navStyles.item}>Labs</div>
            </Link>
              ...
              <div className={navStyles.group}>
                ...
                <div className={navStyles.subLinks} style={{display: open=="oculuslabs" ? "flex" : "none"}}>
                  ...
                  <Link to="/decal/labs/oculus/lab3">
                    <div className={activePage=="oculuslab3" ? navStyles.active : navStyles.item}>Oculus Lab 3</div>
                  </Link>
                  <Link to="/decal/labs/oculus/lab4">
                    <div className={activePage=="oculuslab4" ? navStyles.active : navStyles.item}>Oculus Lab 4</div>
                  </Link>
                </div>
              </div>
